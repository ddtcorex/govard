...
// manifest is Mage-OS's FrameworkManifestConfig literal - registered into
// engine's runtime store by Definition() (via frameworks.Register),
// replacing the old "mageos" entry that used to live in
// internal/engine/framework_manifest.json's "frameworks" object.
// Byte-identical to Magento 2's manifest
// (internal/frameworks/magento2/manifest.go) - the source JSON entries for
// "magento2" and "mageos" were themselves byte-identical except for the
// object key.
