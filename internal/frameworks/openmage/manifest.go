...
// manifest is OpenMage's FrameworkManifestConfig literal - registered into
// engine's runtime store by Definition() (via frameworks.Register),
// replacing the old "openmage" entry that used to live in
// internal/engine/framework_manifest.json's "frameworks" object. Byte-
// identical to Magento1's manifest (magento1/manifest.go) since OpenMage
// shares Magento 1's database schema and sync/exclude shape - not a
// simplification, the source JSON entries for "magento1" and "openmage"
// were themselves identical.
