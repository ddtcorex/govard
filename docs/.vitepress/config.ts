    ...
    '/reference/': [
      {
        ...
        items: [
          ...
          { text: 'Runs Without Docker', link: '/reference/docker-free' },
        ],
      },
    ],
    '/workflows/': [
      {
        ...
        items: [
          ...
          { text: 'Generating CI pipelines', link: '/workflows/ci-generate' },
          { text: 'Deployment', link: '/workflows/deployment' },
          { text: 'Deployment Case Studies', link: '/workflows/deploy-case-studies' },
        ],
      },
    ],
    '/developer/': [
    ...
    '/vi/reference/': [
      {
        ...
        items: [
          ...
          { text: 'Chạy không cần Docker', link: '/vi/reference/docker-free' },
        ],
      },
    ],
    '/vi/workflows/': [
      {
        ...
        items: [
          ...
          { text: 'Audit', link: '/vi/workflows/audit' },
          { text: 'Lock File', link: '/vi/workflows/lock' },
          { text: 'Tunnel', link: '/vi/workflows/tunnel' },
          { text: 'Triển khai', link: '/vi/workflows/deployment' },
          { text: 'Case study triển khai', link: '/vi/workflows/deploy-case-studies' },
          { text: 'Sinh pipeline CI', link: '/vi/workflows/ci-generate' },
        ],
      },
    ],
    '/vi/developer/': [
