...
func ValidateConfig(cfg Config) error {
	...
	// Audit lint is framework-owned. Frameworks without a lint profile may
	// have an empty audit section; do not default it to govard or require
	// validation in that case. If they explicitly configure a provider,
	// still validate it.
